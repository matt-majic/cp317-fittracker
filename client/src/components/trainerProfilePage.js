  ...
  return (
    <div className="profile-container">
      <div className="profile-card">
        <img src={trainer.profileImage} alt="Trainer" className="profile-image" />
        ...
        <div className="profile-description">
          ...
          <p><strong>Clients:</strong> {trainer.clients}</p>
          <p><strong>Sessions:</strong> {trainer.sessions}+</p>
        </div>

        <div className="button-list">
          <button onClick={() => handleNavigation("profile")}>👤 Edit Profile</button>
          <button onClick={() => handleNavigation("financials")}>💰 View Financials</button>
